...
CREATE
DATABASE IF NOT EXISTS DatVeXemPhimCineBoo;
USE
DatVeXemPhimCineBoo;
...
VALUES ('KH001', 'Thành viên thường', 1),
...
INSERT INTO Voucher (MaVoucher, GiaTriDoi, TruTienPhanTram, TruTienSo, SoTienGiam, SoTienToiThieu, GiamToiDa,
                     NgayBatDau, NgayKetThuc, TrangThai)
VALUES ('VC001', 500, 10, NULL, 50000, 100000, 50000, '2024-01-01', '2024-12-31', 1),
...
INSERT INTO Phim (MaPhim, TenPhim, AnhPhim, DienVien, TheLoai, Nam, NoiDungMoTa, Trailer, ThoiLuong, QuocGia,
                  GioiHanDoTuoi, TrangThai)
VALUES ('P001', 'Biệt Đội Siêu Anh Hùng', 'https://anhphim.com/1.jpg', 'Chris Evans, Robert Downey Jr.',
        'Hành động, Phiêu lưu', 2019, 'Phim hành động hấp dẫn', 'https://trailer.com/1', 120, 'Mỹ', 13, 1),
       ('P002', 'Sát Thủ John Wick', 'https://anhphim.com/2.jpg', 'Keanu Reeves', 'Hành động, Hình sự', 2014,
        'Phim sát thủ nổi tiếng', 'https://trailer.com/2', 130, 'Mỹ', 18, 1),
       -- Thêm các phim khác tương tự
       ('P010', 'Chúa Tể Những Chiếc Nhẫn', 'https://anhphim.com/10.jpg', 'Elijah Wood, Viggo Mortensen',
        'Phiêu lưu, Kỳ ảo', 2001, 'Hành trình tiêu diệt chiếc nhẫn', 'https://trailer.com/10', 178, 'New Zealand', 13,
        1);
...
VALUES ('SC001', '2024-11-01 14:30:00', 1, 1, 1),
...
VALUES ('PT01', 'Thanh toán tiền mặt', 1),
       ('PT02', 'Thanh toán thẻ', 1),
       -- Thêm các phương thức thanh toán khác tương tự
       ('PT10', 'Chuyển khoản ngân hàng', 1);
INSERT INTO KhachHang (ID_PhanLoai, Ten, TenDem, Ho, NgaySinh, SoDienThoai, GioiTinh, Email, DanToc, DiaChi, Diem,
                       TrangThai)
VALUES (1, 'Hoàng', 'Đức', 'Nguyễn', '1995-05-15', '0987654321', 1, 'hoang.nguyen@example.com', 'Kinh',
        '789 XYZ, Hà Nội', 200, 1),
       -- Thêm các khách hàng khác tương tự
       (2, 'Mai', 'Thị', 'Phạm', '1988-08-08', '0912345678', 0, 'mai.pham@example.com', 'Kinh', '987 UVW, Hà Nội', 300,
        1);
