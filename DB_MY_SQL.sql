...
VALUES 
    ('P001', 'Biệt Đội Siêu Anh Hùng', 'https://anhphim.com/1.jpg', 'Chris Evans, Robert Downey Jr.', 'Hành động, Phiêu lưu', 2019, 'Phim hành động hấp dẫn', 'https://trailer.com/1', 120, 'Mỹ', 13, 1),
    ('P002', 'Sát Thủ John Wick', 'https://anhphim.com/2.jpg', 'Keanu Reeves', 'Hành động, Hình sự', 2014, 'Phim sát thủ nổi tiếng', 'https://trailer.com/2', 130, 'Mỹ', 18, 1),
    -- Thêm các phim khác tương tự
    ('P010', 'Chúa Tể Những Chiếc Nhẫn', 'https://anhphim.com/10.jpg', 'Elijah Wood, Viggo Mortensen', 'Phiêu lưu, Kỳ ảo', 2001, 'Hành trình tiêu diệt chiếc nhẫn', 'https://trailer.com/10', 178, 'New Zealand', 13, 1);
