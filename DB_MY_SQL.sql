...
INSERT INTO Phim (MaPhim, TenPhim, AnhPhim, DienVien, TheLoai, Nam, NoiDungMoTa, Trailer, ThoiLuong, QuocGia, NoiDung, GioiHanDoTuoi, TrangThai)
VALUES 
    ('PH001', 'Phim A', 'anhphim_a.jpg', 'Dien Vien A', 'The Loai A', 2023, 'Mo ta phim A', 'trailer_a.mp4', 120, 'Viet Nam', 'Noi dung phim A', 18, 1),
    ('PH002', 'Phim B', 'anhphim_b.jpg', 'Dien Vien B', 'The Loai B', 2022, 'Mo ta phim B', 'trailer_b.mp4', 150, 'My', 'Noi dung phim B', 15, 1),
    ('PH003', 'Phim C', 'anhphim_c.jpg', 'Dien Vien C', 'The Loai C', 2024, 'Mo ta phim C', 'trailer_c.mp4', 90, 'Han Quoc', 'Noi dung phim C', 12, 1);
